 ...
 */
gulp.task('develop', gulp.series('build-clean', 'sass', 'javascript', 'image-min', 'pug', 'browser-sync'));

/**
 * Building distributive
 * Создаем дистрибутив
 */
gulp.task('build-dist', gulp.series('build-clean', 'sass', 'javascript', 'image-min', 'pug'));
...
gulp.task('watch', function () {
  gulp.watch(paths.input.sass + '**/*.scss', gulp.parallel('sass'));
  gulp.watch(paths.input.js + '**/*.js', gulp.parallel('javascript'));
  gulp.watch(paths.input.images + '**/*', gulp.parallel('image-min'));
 ...
 */
gulp.task('default', gulp.series('develop', 'watch'));
